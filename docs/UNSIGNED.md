# Running unsigned Resolve Configurator builds
...
```sh
codesign --force --deep --sign - "/Applications/Resolve Configurator.app"
```

Verify it took:

```sh
codesign -dv --verbose=4 "/Applications/Resolve Configurator.app"
spctl -a -vv "/Applications/Resolve Configurator.app"   # still reports "rejected" — ad-hoc is not notarization
```
